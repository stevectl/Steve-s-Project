...
class BlacklistGui:
    """
    a blacklist GUI for hotel to blacklist users.
    instantiates a seperate but same Hotel with the same files used in Hotel.py
    there are 3 functions created each for a Button
    a seperate function is created for saving blacklist into .txt file for easier changing of .txt file
    """
    ...
    def __init__(self):
        ...
        self._window = Tk()
        self._window.title("SAMI Blacklist GUI - done by Steve Chia")
        ...
        self.passportLabel = Label(master=self.passportFrame, text="Passport:")
